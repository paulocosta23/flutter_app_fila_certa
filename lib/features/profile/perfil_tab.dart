...
class _PerfilTabState extends State<PerfilTab> {
  ...
  Future<void> _goToEditProfile() async {
    final result = await Navigator.push<Map<String, String>>(
      context,
      MaterialPageRoute(
        builder: (_) => EditProfileView(name: _name, email: _email, phone: _phone),
      ),
    );
    if (result != null) {
      setState(() {
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              _InfoCard(icon: Icons.person, title: _name, subtitle: "Nome completo"),
